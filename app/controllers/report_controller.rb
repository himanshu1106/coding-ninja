class ReportController < ApiController
    ...
    #   @avg_resolution_time  = Doubt.solved.select("doubts.solved_by, count (doubts.*) as sum, avg(doubts.solved_at - doubts.created_at) as time_val").group("doubts.solved_by").as_json
